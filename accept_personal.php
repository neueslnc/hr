                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered table-striped mb-0" id="datatable-tabletools">
                                ...
                                <?php
                                    ...
                                    $result = $DB->query("SELECT p.*, c.comment FROM `personnel` as p LEFT JOIN comments as c ON c.person_id = p.id AND c.user_id = ? WHERE p.status = 1 GROUP BY p.id ORDER BY c.comment ASC", array(getUserId()));
