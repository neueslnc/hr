...
$id= $_GET['id'] ;
$result = $DB->query("SELECT e.*, d.depname FROM `employers` as e LEFT JOIN departments as d ON e.department = d.id WHERE e.id = ? ORDER BY e.id DESC",array("$id"));
                ...
                <div class="row action-buttons">
                    ...
                    <div class="col-12 col-md-auto ms-md-auto mt-3 mt-md-0 ms-auto">
                        <a href="#" class="delete-button btn btn-danger btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1">
                            <i class="bx bx-trash text-4 me-2"></i> Xodimni o`chirish
                        </a>
                    </div>
                </div>
            </form>A
