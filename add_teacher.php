            ...
            <header class="page-header">
                ...
                <div class="right-wrapper text-end">
                    <ol class="breadcrumbs">
                        ...
                        <li><span>Yangi o`qituvchi</span></li>
                        ...
                        <div class="card-body">
                            <section class="card">
                                <header class="card-header">
                                    ...
                                    <h2 class="card-title">Yangi o`qituvchi qo`shish</h2>
                                    ...
                                    <div class="card-body">
                                        <div class="row form-group mb-3">
                                            ...
                                            <div class="col-sm-12 col-md-4 pb-sm-3 pb-md-0">
                                                ...
                                                <input type="text" name="workbegindate" placeholder="Ishga kirgan vaqti" class="form-control">
                                            </div>
                                            <div class="col-sm-12 col-md-4 pb-sm-3 pb-md-0">
                                            ...
                                            <div class="col-sm-6 col-md-4 pb-sm-3 pb-md-0">
                                                <label class="col-form-label">Ish</label>
                                                <div class="col-lg-6">
                                                    <select data-plugin-selectTwo class="form-control populate" name="ish">
                                                            <option value="1">Asosiy</option>
                                                            <option value="2">Soatbay</option>
                                                            <option value="1">O`rindoshlik asosida</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-md-4 pb-sm-3 pb-md-0">
                                                <label class="col-form-label" for="formGroupExampleInput">Mutaxassisligi</label>
                                                <input type="text" name="spec" placeholder="Mutaxassisligi" class="form-control">
                                            </div>
                                            <div class="col-sm-12 col-md-4 pb-sm-3 pb-md-0">
                                                <label class="col-form-label" for="formGroupExampleInput">Fani</label>
                                                <input type="text" name="fani" placeholder="Fani" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <textarea class="form-control" rows="5" name="izoh" placeholder="Izoh"></textarea>
                                            </div>
                                        </div>
                                    </div>
