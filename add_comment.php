                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered table-striped mb-0" id="datatable-tabletools">
                                ...
                                <?php
                                    ...
                                    $result = $DB->query("SELECT * FROM personnel AS p");

                                    $i = 0;
                                    foreach ($result as $key) {
                                    $i++;
                                    
                                    $comment = $DB->query('SELECT * FROM comments as c WHERE c.user_id = ? AND c.person_id = ?', array(getUserId(), $key['id']));

                                    if (empty($comment)) {
                                    ?>
                                    <tr>
                                        <td><a href="view_profile.php?id=<?php echo $key['id']; ?>"><?php echo $i;?></a></td>
                                        <td><a href="view_profile.php?id=<?php echo $key['id']; ?>"><?php echo $key['fio'];?></a></td>
                                        <td><a href="view_profile.php?id=<?php echo $key['id']; ?>"><?php echo $key['bith_date'];?></a></td>
                                        <td><a href="view_profile.php?id=<?php echo $key['id']; ?>"><?php echo $key['direction'];?></a></td>
                                        <td><a href="view_profile.php?id=<?php echo $key['id']; ?>"><img src="<?php echo $key['foto'];?>" alt="<?php echo $key['fio'];?>" width="100" height="100"></a></td>
                                        <td></td>
                                    </tr>
